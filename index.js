...
}(this, function (undefined) {var parsers = {
  html: {
    jade: function(html) {
...
function compileCSS(style, tag, type, scoped) {
  ...
  else if (parsers.css[type]) style = parsers.css[type](tag, style)
...
function compile(src, opts) {
  ...
  if (!opts) opts = {}
    ...
    if (opts.brackets) opts.brackets
...
function loadAndCompile(arg, fn) {
